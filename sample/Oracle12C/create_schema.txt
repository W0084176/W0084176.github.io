...
spool create_schema.lst

ECHO ON

--Connect as sys and plug to database
CONN / AS SYSDBA
...
CREATE INDEX  "WF_CTRY_REG_IDX" ON  WF_COUNTRIES ("REGION_ID") TABLESPACE DEV_IDX;
...
CREATE INDEX  "WF_CTRY_CURR_IDX" ON  WF_COUNTRIES ("CURRENCY_CODE") TABLESPACE DEV_IDX;
...
CREATE INDEX  "D_CDS_IDX" ON  "D_CDS" ("TITLE") TABLESPACE DEV_IDX;
CREATE INDEX  "SONG_ID_IDX" ON  "D_TRACK_LISTINGS" ("SONG_ID") TABLESPACE DEV_IDX;
...
CREATE INDEX  "DEPT_LOCATION_IX" ON  "DEPARTMENTS" ("LOCATION_ID") TABLESPACE DEV_IDX;
...
CREATE INDEX  "EMP_DEPARTMENT_IX" ON  "EMPLOYEES" ("DEPARTMENT_ID") TABLESPACE DEV_IDX;
CREATE INDEX  "EMP_JOB_IX" ON  "EMPLOYEES" ("JOB_ID") TABLESPACE DEV_IDX;
CREATE INDEX  "EMP_MANAGER_IX" ON  "EMPLOYEES" ("MANAGER_ID");
CREATE INDEX  "EMP_NAME_IX" ON  "EMPLOYEES" ("LAST_NAME", "FIRST_NAME") TABLESPACE DEV_IDX;
...
ALTER TABLE  "JOB_HISTORY" ADD CONSTRAINT "JHIST_JOB_FK" FOREIGN KEY ("JOB_ID")
	  REFERENCES  "JOBS" ("JOB_ID") ENABLE;
CREATE INDEX  "JHIST_DEPARTMENT_IX" ON  "JOB_HISTORY" ("DEPARTMENT_ID") TABLESPACE DEV_IDX;
CREATE INDEX  "JHIST_EMPLOYEE_IX" ON  "JOB_HISTORY" ("EMPLOYEE_ID") TABLESPACE DEV_IDX;
CREATE INDEX  "JHIST_JOB_IX" ON  "JOB_HISTORY" ("JOB_ID") TABLESPACE DEV_IDX;
